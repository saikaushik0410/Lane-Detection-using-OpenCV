...
cap = cv2.VideoCapture(r'C:\Users\Admin\Desktop\Python\Lane Detection\test2.mp4')
while(cap.isOpened()):
    _, frame = cap.read()
    ...
    combo_img = cv2.addWeighted(frame, 0.8, line_img, 1,1) #line img will have 20%more weight
    cv2.imshow('result', combo_img)
